...
/// <summary>
/// Represents a singleton Coroutine.
/// </summary>
public class Countdown
{
    public delegate Coroutine CountdownFunction();
    /// <summary>
    /// Gets or sets whether the Countdown is currently running.
    /// </summary>
    public bool active {
        set
        {
    ...
    /// </summary>
    /// <returns><c>True</c> if the Countdown was started; <c>False</c> if the Countdown was already running.</returns>
    public bool Start()
    {
        if (countdown == null)
        {
    ...
    /// <summary>
    /// Starts or Restarts the coroutine from the beginning, resetting it if it was already running.
    /// </summary>
    public void Restart()
    {
        Stop();
